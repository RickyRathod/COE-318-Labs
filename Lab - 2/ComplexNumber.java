...
//Initialize the instance variables
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        return new ComplexNumber (re * z.re - im * z.im, im * z.re + re * z.im);	//A stub: to be fixed
    }
    ...
    public ComplexNumber reciprocal() {
        ...
        return new ComplexNumber (re/denominator , -im/denominator);	//A stub: to be fixed
    }
    ...
    public ComplexNumber divide(ComplexNumber z) {
        ...
        double reNum = re * z.re + im * z.im ;
        double imNum = im * z.re - re * z.im;
        return new ComplexNumber (reNum/denominator, imNum/denominator);	//A stub: to be fixed
    }
